        ...
        <div className='contenedor_home'>
            ...
            <div className='categorias'>
                ...
                <div className='cartas_categorias'>
                    ...
                    <div className='carta_categorias'>
                        <div className='imagen_categoria'>
                            <Link to="/categoria/Cerraduras"><img src="/img/Cerraduras.png" alt="imagen de cerradura para caracterizar la categoria de Cerraduras"></img></Link> 
                        </div>
                        <p><Link to="/categoria/Cerraduras" className='nombre_categoria'>Cerraduras</Link></p>
                    </div>

                    {/* BRAZOS */}
                    <div className='carta_categorias'>
                        <div className='imagen_categoria'>
                            <Link to="/categoria/Brazos"><img src="/img/Brazos.png" alt="imagen de brazo para caracterizar la categoria de Brazos"></img></Link> 
                        </div>
                        <p><Link to="/categoria/Brazos" className='nombre_categoria'>Brazos</Link></p>
                    </div>
                </div>
                ...
                <div className='cartas_categorias'>
                    ...
                    <div className='carta_categorias'>
                        <div className='imagen_categoria'>
                            <Link to="/categoria/Rodamientos"><img src="/img/Rodamientos.png" alt="imagen de rodamiento para caracterizar la categoria de Rodamientos"></img></Link> 
                        </div>
                        <p><Link to="/categoria/Rodamientos" className='nombre_categoria'>Rodamientos</Link></p>
                    </div>

                    {/* ESCUADRAS */}
                    <div className='carta_categorias'>
                        <div className='imagen_categoria'>
                            <Link to="/categoria/Escuadras"><img src="/img/Escuadras.png" alt="imagen de escuadra para caracterizar la categoria de Escuadras"></img></Link> 
                        </div>
                        <p><Link to="/categoria/Escuadras" className='nombre_categoria'>Escuadras</Link></p>
                    </div>
                </div>
                ...
                <div className='cartas_categorias'>
                    ...
                    <div className='carta_categorias'>
                        <div className='imagen_categoria'>
                            <Link to="/categoria/Accesorios A30"><img src="/img/A30.png" alt="imagen de accesorio A30 para caracterizar la categoria de Accesorios A30"></img></Link> 
                        </div>
                        <p><Link to="/categoria/Accesorios A30" className='nombre_categoria'>Accesorios A30</Link></p>
                    </div>

                    {/* ACCESORIO MODENA */}
                    <div className='carta_categorias'>
                        <div className='imagen_categoria'>
                            <Link to="/categoria/Accesorios Modena"><img src="/img/Modena.png" alt="imagen de accesorio Modena para caracterizar la categoria de Accesorios Modena"></img></Link> 
                        </div>
                        <p><Link to="/categoria/Accesorios Modena" className='nombre_categoria'>Accesorios Modena</Link></p>
                    </div>
